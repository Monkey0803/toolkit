...
export const tools: Tool[] = [
  ...
  { id: 'image-resizer', name: 'Image Resizer', nameZh: '图片缩放', description: 'Calculate proportional image sizes before exporting assets.', descriptionZh: '计算等比图片尺寸。', category: 'Image & Color', icon: 'img', tags: ['image', 'resize', 'design'] },
  { id: 'qr-code-maker', name: 'QR Code Maker', nameZh: '二维码生成', description: 'Turn a link or short message into a scannable code.', descriptionZh: '将链接或短消息转换为可扫描二维码。', category: 'Generators', icon: 'QR', tags: ['qr', 'link', 'share'] },
